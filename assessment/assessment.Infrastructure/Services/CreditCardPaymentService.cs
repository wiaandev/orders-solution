...
public class CreditCardPaymentService(IPaymentGatewayClient paymentGatewayClient) : IPaymentService
{
    public async Task<PaymentProcessResult> ProcessPaymentAsync(decimal amountToBePaid, CancellationToken ct)
    {
        ...
        return new PaymentProcessResult(statusCode == HttpStatusCode.OK, PayMethod.CreditCard);
    }
}